              ...
              {kernel.metadata && (
                  <div className="mb-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                          ...
                          {Object.entries(kernel.metadata).filter(
                              ([_key, value]) => isLongValue(value)
                          ).length > 0 && (
              ...
              {kernel.launchDiff && (
                  <div className="mb-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                          ...
                          {/* Unchanged Fields */}
                          {kernel.launchDiff.sames &&
                              Object.keys(kernel.launchDiff.sames).length >
                                  0 && (
                                  <div className="mb-4">
                                      <h4 className="text-md font-semibold mb-2 text-gray-800">
