          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  {/* This SVG icon represents the GitHub logo, symbolizing the "GitHub"
                      functionality where users can view the project repository.
                      The GitHub logo indicates the source code repository and project page. */}
                ...
                <a
                  ...
                  title="View Wiki"
                >
                  {/* This SVG icon represents a book or document, symbolizing the "Wiki"
                      functionality where users can access project documentation.
                      The book icon indicates the project's knowledge base and documentation. */}
                ...
                {fbDirectoryExists && (
                  ...
                  >
                    {/* This SVG icon represents a book or document, symbolizing the "Internal Wiki"
                        functionality where users can access internal documentation.
                        The book icon indicates internal knowledge base or documentation. */}
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                    </svg>
                    <span className="text-sm font-medium">Internal Wiki</span>
                  </a>
                )}
              </div>
            </div>
